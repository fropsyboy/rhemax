...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{ asset('back/css/material-dashboard.css?v=2.1.1') }}" rel="stylesheet" />
...
<body class="">
  ...
  <script src="{{ asset('back/js/plugins/jquery.min.js') }}"></script>
  ...
  <script src="{{ asset('back/js/material-dashboard.js?v=2.1.1') }}" type="text/javascript"></script>
